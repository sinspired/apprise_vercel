...
[![Apprise Version](https://img.shields.io/github/v/release/caronc/apprise?logo=python&label=apprise&color=00A98F)](https://github.com/caronc/apprise)
...
点击下方按钮，一键部署到你的 `Vercel` 账户，建议先 fork 本项目：
